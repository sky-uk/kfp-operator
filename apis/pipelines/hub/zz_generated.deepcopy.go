...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JSONWrapper) DeepCopyInto(out *JSONWrapper) {
	*out = *in
	in.Raw.DeepCopyInto(&out.Raw)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JSONWrapper.
func (in *JSONWrapper) DeepCopy() *JSONWrapper {
	if in == nil {
		return nil
	}
	out := new(JSONWrapper)
...
func (in *PipelineFramework) DeepCopyInto(out *PipelineFramework) {
	*out = *in
	if in.Parameters != nil {
		...
		*out = make(map[string]*JSONWrapper, len(*in))
		for key, val := range *in {
			var outVal *JSONWrapper
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
