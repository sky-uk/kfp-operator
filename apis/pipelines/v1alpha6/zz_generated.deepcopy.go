...
func (in *ProviderConversionRemainder) DeepCopyInto(out *ProviderConversionRemainder) {
	*out = *in
	...
	if in.PodTemplateVolumes != nil {
		in, out := &in.PodTemplateVolumes, &out.PodTemplateVolumes
		*out = make([]corev1.Volume, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PodTemplateVolumeMounts != nil {
		in, out := &in.PodTemplateVolumeMounts, &out.PodTemplateVolumeMounts
