...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OutputArtifactsConversionRemainder) DeepCopyInto(out *OutputArtifactsConversionRemainder) {
	*out = *in
	if in.Artifacts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OutputArtifactsConversionRemainder.
func (in *OutputArtifactsConversionRemainder) DeepCopy() *OutputArtifactsConversionRemainder {
	if in == nil {
		return nil
	}
	out := new(OutputArtifactsConversionRemainder)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RunConfigurationConversionRemainder) DeepCopyInto(out *RunConfigurationConversionRemainder) {
	*out = *in
	in.OutputArtifactsConversionRemainder.DeepCopyInto(&out.OutputArtifactsConversionRemainder)
