...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (rc *RunConfiguration) DeepCopyInto(out *RunConfiguration) {
	*out = *rc
	out.TypeMeta = rc.TypeMeta
	rc.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	rc.Spec.DeepCopyInto(&out.Spec)
	out.Status = rc.Status
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunConfiguration.
func (rc *RunConfiguration) DeepCopy() *RunConfiguration {
	if rc == nil {
		return nil
	}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (rc *RunConfiguration) DeepCopyObject() runtime.Object {
	if c := rc.DeepCopy(); c != nil {
		return c
	}
	return nil
}
