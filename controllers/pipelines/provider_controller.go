...
func (r *ProviderReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if providerServiceDeployment == nil {
		providerServiceDeployment = constructProviderServiceDeployment(providerServiceName, req.Namespace, provider.GetName())
		...
		logger.Info("found provider service deployment", "resource", providerServiceDeployment)
	}
...
func constructProviderServiceDeployment(name, namespace, providerName string) *appsv1.Deployment {
