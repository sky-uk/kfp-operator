...
func (r *RunReconciler) reconciliationRequestsForPipeline(ctx context.Context, pipeline client.Object) []reconcile.Request {
...
func (r *RunReconciler) reconciliationRequestsForRunconfigurations(ctx context.Context, runConfiguration client.Object) []reconcile.Request {
	referencingRuns := &pipelinesv1.RunList{}
	listOps := &client.ListOptions{
