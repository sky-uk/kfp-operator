...
func (r *RunConfigurationReconciler) updateRcTriggers(
	...
	if apis.Contains(runConfiguration.Spec.Triggers.OnChange, pipelineshub.OnChangeTypes.Pipeline) {
		newStatus.Triggers.TriggeredPipelineVersion = runConfiguration.Status.Dependencies.ObservedPipelineVersion
	}
...
func (r *RunConfigurationReconciler) syncWithRuns(
	...
	if runConfiguration.Status.Triggers.Equals(oldStatus.Triggers) &&
		runConfiguration.Status.Triggers.TriggeredPipelineVersion == oldStatus.Triggers.TriggeredPipelineVersion {
		return false, nil
	}
...
func (r *RunConfigurationReconciler) constructRunForRunConfiguration(
	...
	spec.Pipeline.Version = runConfiguration.Status.Dependencies.ObservedPipelineVersion
		...
		runSchedule := pipelineshub.RunSchedule{
			...
			Spec: pipelineshub.RunScheduleSpec{
				...
				Pipeline: pipelineshub.PipelineIdentifier{
					...
					Version: runConfiguration.Status.Dependencies.ObservedPipelineVersion,
				},
