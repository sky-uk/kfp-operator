...
type MetadataStoreServiceClient interface {
	...
	// changes of the Artifact used or generated by the Execution, as well as the
	...
	//	artifact_event_pairs: Artifact to insert or update and events to insert.
