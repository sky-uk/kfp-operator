...
KFP SDK compiler is compatible with KFP SDK [2.12.2](https://kubeflow-pipelines.readthedocs.io/en/sdk-2.12.1/), supports Python 3.9 through 3.12, and requires minimum of `v1beta1` Pipeline resource definition with:
