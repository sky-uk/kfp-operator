...
| `manager.monitoring.rbacSecured`                          | Enable additional RBAC-based security                                                                                                                                                                                |
...
| `logging.verbosity`                                       | Logging verbosity for all components - see the [logging documentation]({{< param "github_project_repo" >}}/blob/versions/v0.6.0/CONTRIBUTING.md#logging) for valid values                                                    |
