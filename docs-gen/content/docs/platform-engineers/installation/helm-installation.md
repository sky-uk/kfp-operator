...
| `manager.argo.securityContext`                            | [Security Context](https://argo-workflows.readthedocs.io/en/latest/workflow-pod-security-context/) applied to Argo WorkflowTemplate specs - required for clusters with Pod Security Standards or admission policies like Gatekeeper |
