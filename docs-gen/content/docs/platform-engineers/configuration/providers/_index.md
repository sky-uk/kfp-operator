...
The provider service is the first point of contact for [Run Completion Events](../../events/run-completion) received from the
...
2. **Configure Run Completion Events**: Integrate your provider with an eventing mechanism compatible with the KFP Operator. See the [Run Completion Events](../../events/run-completion) documentation for more information.
