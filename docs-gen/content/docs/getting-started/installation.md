...
| `manager.multiversion.storedVersion`                      | Must be set if `manager.multiversion.enabled` is set to `true`. It specifies which version of the CRDs should be set as the stored version.                                                                         |
