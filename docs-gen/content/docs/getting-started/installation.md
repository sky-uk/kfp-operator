...
| `manager.argo.stepTimeoutSeconds.default`                 | The maximum number of seconds that each non-compiler workflow step can run before being terminated - defaults to 300 (5m)                                                                                           |
| `manager.argo.stepTimeoutSeconds.compile`                 | The maximum number of seconds that each compiler workflow step can run before being terminated - defaults to 1800 (60m)                                                                                             |
