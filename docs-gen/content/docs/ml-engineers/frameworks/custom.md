...
3. Update your [Provider](../../../platform-engineers/configuration/providers/) resource to support your custom framework by specifying your framework name and image in `spec.frameworks[]`.
