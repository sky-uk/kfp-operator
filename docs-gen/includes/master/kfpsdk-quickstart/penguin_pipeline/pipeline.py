...
def trainer(
    ...
    import keras
    import torch
    from penguin_pipeline.model import MyModel
...
@dsl.pipeline(
    name='kfpsdk-penguin-pipeline-extended',
    description='An example pipeline that performs two additions and stores the results as artifacts.',
