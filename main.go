...
func main() {
	...
	pipelineshubalpha5.DefaultWorkflowNamespace = ctrlConfig.Spec.WorkflowNamespace
	pipelineshubalpha6.DefaultWorkflowNamespace = ctrlConfig.Spec.WorkflowNamespace
